...
namespace RolePlayingGameProcessors
{
    public abstract class RolePlayingGameWriter<T> : ContentTypeWriter<T>
    {
        public override string GetRuntimeReader(TargetPlatform targetPlatform)
        {
            ...
            readerText += ", RolePlayingGameDataWindows, Version=1.0.0.0, PublicKeyToken=null";
        ...
        public override string GetRuntimeType(TargetPlatform targetPlatform)
        {
            ...
            string typeText = type.FullName + ", RolePlayingGameDataWindows, Version=1.0.0.0, PublicKeyToken=null";
